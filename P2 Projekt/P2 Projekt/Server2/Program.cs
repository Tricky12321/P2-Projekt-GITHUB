...
public static class Program
{
    ...
    public static void TestBusSimulering()
    {
        ...
        Stoppested stopJumfruAneGade = new Stoppested("Jomfru Ane Gade (Borgergade / Aalborg)", 8, new GPS(57.051035, 9.918944)                                       /* , new BusTidCombi(bus2, new Tidspunkt(11, 21)), new BusTidCombi(bus3, new Tidspunkt(12, 21))*/);
