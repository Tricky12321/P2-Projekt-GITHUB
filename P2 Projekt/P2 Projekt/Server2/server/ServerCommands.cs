...
public static class ServerCommands
{
    ...
    public static void enfuckingfunktion()
    {
        ...
        */
        Debug.Print(OuputBus.StoppeStederMTid[6].AfPåTidComb[0].ForventetPassagere.ToString());
        Debug.Print(OuputBus.StoppeStederMTid[7].AfPåTidComb[0].ForventetPassagere.ToString());
        Debug.Print(OuputBus.StoppeStederMTid[8].AfPåTidComb[0].ForventetPassagere.ToString());
        Debug.Print(OuputBus.StoppeStederMTid[9].AfPåTidComb[0].ForventetPassagere.ToString());
