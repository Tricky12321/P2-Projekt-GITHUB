...
namespace ProgramTilBusselskab
{
    public partial class Simulation : Form
    {
        ...
        private void gMapsMap_Load(object sender, EventArgs e)
        {
            ...
            Stoppested stopRødhøjvej = new Stoppested("Rødhøjvej (Storvorde)", 38, new GPS(56.999864, 10.100411)        
            ...
            Bus bus2 = new Bus("bus2", 123, 56, 47, rute2VædSto, (new StoppestedMTid(stopSkydebanevej, (new AfPåTidCombi(new Tidspunkt(12, 00))), (new AfPåTidCombi(new Tidspunkt(13, 00))))), (new StoppestedMTid(stopVandværksvej, (new AfPåTidCombi(new Tidspunkt(14, 00))), (new AfPåTidCombi(new Tidspunkt(15, 00))))));
        ...
        private void btn_visPåKort_Click(object sender, EventArgs e)
        {
            ...
            if (chkbox_toggleStoppesteder.Checked == true)
            {
                ...
                foreach (Stoppested stop in ((Rute)combox_ruterTilVisning.SelectedItem).AfPåRuteList)
                {
                    GMapMarker stoppested =
                    new GMap.NET.WindowsForms.Markers.GMarkerGoogle(
                    new PointLatLng(stop.StoppestedLok.xCoordinate, stop.StoppestedLok.yCoordinate),
